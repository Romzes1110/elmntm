...
define('DB_USER', 'f0797821_elmntm');
define('DB_PASSWORD', 'elmntm123');
define('DB_NAME', 'f0797821_elmntm');
...
function getOptions() {
    ...
    $condensators = (isset($_GET['condensators'])) ? implode($_GET['condensators'], ',') : null;
    $sound_power = (isset($_GET['sound_power'])) ? implode($_GET['sound_power'], ',') : null;
